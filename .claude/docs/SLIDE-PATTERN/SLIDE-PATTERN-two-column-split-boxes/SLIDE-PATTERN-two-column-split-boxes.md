...
| 要素 | 配置 | 役割 |
|---|---|---|
| 左ボックス見出し | 左カラム上部 | 左側コンテンツのテーマ（40px相当） |
| 左ボックス本文 | 左カラム内 | 詳細説明・3〜5行（26px相当） |
| 接続シンボル | 中央 | 2要素の関係性（矢印=変化、円=連携等）を示す（36px相当） |
| 右ボックス見出し | 右カラム上部 | 右側コンテンツのテーマ（40px相当） |
| 右ボックス本文 | 右カラム内 | 詳細説明・3〜5行（26px相当） |
